...
- HTTP still serves initial documents, canonical GET pages and real link and form markup. JavaScript is required for live projections and command patches. The server stays authoritative.
